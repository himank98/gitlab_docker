# -*- encoding: utf-8 -*-
# stub: doorkeeper 5.0.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<danger>.freeze, ["~> 5.0"])
      ...
      s.add_dependency(%q<capybara>.freeze, ["~> 2.18"])
      s.add_dependency(%q<coveralls>.freeze, [">= 0"])
      s.add_dependency(%q<danger>.freeze, ["~> 5.0"])
