...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<oauth>.freeze, ["~> 0.5", ">= 0.5.0"])
      s.add_development_dependency(%q<guard>.freeze, ["~> 2.13", ">= 2.13.0"])
      ...
      s.add_dependency(%q<oauth>.freeze, ["~> 0.5", ">= 0.5.0"])
      s.add_dependency(%q<guard>.freeze, ["~> 2.13", ">= 2.13.0"])
      ...
      s.add_dependency(%q<rspec>.freeze, ["~> 3.0", ">= 3.0.0"])
      s.add_dependency(%q<webmock>.freeze, ["~> 1.18", ">= 1.18.0"])
    end
  else
    s.add_dependency(%q<activesupport>.freeze, [">= 0"])
    s.add_dependency(%q<atlassian-jwt>.freeze, [">= 0"])
