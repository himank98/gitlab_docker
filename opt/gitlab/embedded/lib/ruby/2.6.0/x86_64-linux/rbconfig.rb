...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/gitlab/embedded")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/gitlab/embedded' '--without-ext=dbm,readline' '--enable-shared' '--disable-install-doc' '--without-gmp' '--without-gdbm' '--without-tk' '--disable-dtrace' '--with-opt-dir=/opt/gitlab/embedded' 'CFLAGS=-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe -fno-omit-frame-pointer' 'LDFLAGS=-Wl,-rpath,/opt/gitlab/embedded/lib -L/opt/gitlab/embedded/lib' 'CPPFLAGS=-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe -fno-omit-frame-pointer' 'CXXFLAGS=-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe -fno-omit-frame-pointer'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/gitlab/embedded"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-rpath,/opt/gitlab/embedded/lib -L/opt/gitlab/embedded/lib -Wl,--compress-debug-sections=zlib -L/opt/gitlab/embedded/lib  -Wl,-rpath,/opt/gitlab/embedded/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (Ubuntu 5.4.0-6ubuntu1~16.04.12) 5.4.0 20160609\nCopyright (C) 2015 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe -fno-omit-frame-pointer"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe -fno-omit-frame-pointer -I/opt/gitlab/embedded/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -Wl,-rpath,/opt/gitlab/embedded/lib -L/opt/gitlab/embedded/lib -fstack-protector-strong -rdynamic -Wl,-export-dynamic -L/opt/gitlab/embedded/lib  -Wl,-rpath,/opt/gitlab/embedded/lib"
  CONFIG["CFLAGS"] = "-I/opt/gitlab/embedded/include -O2 -O3 -g -pipe -fno-omit-frame-pointer -fPIC"
  CONFIG["CC"] = "gcc"
